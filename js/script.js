...
// ScrollReveal().reveal('.pricing-cards',{
//   distance: '20%',
//   origin: 'bottom',
//   opacity: 0,
//   duration: 1600,
//   delay: 300
// });
ScrollReveal().reveal('.first-gall',{
  distance: '120%',
  origin: 'left',
  opacity: 0,
  duration: 1600,
...
ScrollReveal().reveal('.item-price-first',{
  distance: '120%',
  origin: 'bottom',
  opacity: 0,
  duration: 700,
...
ScrollReveal().reveal('.item-price-sec',{
  distance: '120%',
  origin: 'bottom',
  opacity: 0,
  duration: 900,
...
ScrollReveal().reveal('.item-price-thrd',{
  distance: '120%',
  origin: 'bottom',
  opacity: 0,
  duration: 1100,
...
ScrollReveal().reveal('.footer__down',{
  distance: '50%',
  origin: 'right',
  opacity: 0,
  duration: 1600,
